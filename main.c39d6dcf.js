...
},{"moment":"../node_modules/moment/moment.js"}],"disease.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Disease.prototype.pushData = function () {
    this.stats.push({
  ...
  Disease.prototype.infect = function (n) {
    if (n === void 0) {
      n = 1;
    }
  ...
  Disease.prototype.reset = function () {
    this.setState(this.history[0]);
    this.stats.splice(1);
    this.history.splice(1);
  };

  Disease.prototype.setState = function (state) {
  ...
  Disease.prototype.step = function () {
    if (this.active) {
      var transmitted = (1 - Math.pow(1 - this.rate / this.contagiousTicks / this.socialDistance / this.population, this.currentInfected)) * this.population; // number of transmissions that weren't already infected

      var newCases = transmitted * (1 - this.totalCases / this.population);
      ...
      this.residual = this.residual % 1; // rotate out recoveries, rotate in new cases
  ...
  Disease.prototype.run = function () {
    while (this.active) {
      this.step();
    }
  ...
  Object.defineProperty(Disease.prototype, "currentInfected", {
    get: function get() {
      return this.currentInfectedRotation.reduce(function (acc, n) {
        return acc + n;
      });
    },
    enumerable: true,
  ...
  Object.defineProperty(Disease.prototype, "stepData", {
    get: function get() {
  ...
  Object.defineProperty(Disease.prototype, "allData", {
    get: function get() {
      return this.stats;
    },
    enumerable: true,
...
function updateView() {
  ...
  chart.data.datasets[1].data = disease.allData.map(function (step) {
    return {
      x: step.time,
      y: step.new
    };
  });
  chart.data.datasets[2].data = disease.allData.map(function (step) {
    return {
      x: step.time,
      y: step.current
    };
...
document.getElementById("start").addEventListener("click", function () {
  disease.socialDistance = parseFloat(document.getElementById("social-distance").value) || disease.socialDistance;
  disease.reset();
  updateView();
});
